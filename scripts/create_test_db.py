...
def create_main_database():
    ...
    grades.extend([
        (1, 1, 'Quiz 1', 85.5, '2024-01-15'),
        (1, 1, 'Quiz 2', 72.0, '2024-01-22'),
        (1, 1, 'Midterm', 68.0, '2024-02-05'),
        (1, 1, 'Quiz 3', 65.0, '2024-02-12'),
        # Science: Average
        (1, 2, 'Lab 1', 78.0, '2024-01-10'),
        (1, 2, 'Quiz 1', 80.5, '2024-01-20'),
        (1, 2, 'Midterm', 79.0, '2024-02-10'),
        # English: Good
        (1, 3, 'Essay 1', 88.0, '2024-01-18'),
        (1, 3, 'Quiz 1', 85.5, '2024-01-25'),
        (1, 3, 'Midterm', 87.0, '2024-02-15'),
        # History: Average
        (1, 4, 'Essay 1', 76.0, '2024-01-12'),
        (1, 4, 'Quiz 1', 78.5, '2024-01-30'),
    ])

    # Student 2 (Alice): Mixed performance
    grades.extend([
        (2, 1, 'Quiz 1', 92.0, '2024-01-15'),
        (2, 1, 'Quiz 2', 88.0, '2024-01-22'),
        (2, 2, 'Lab 1', 68.0, '2024-01-10'),
        (2, 2, 'Quiz 1', 65.5, '2024-01-20'),
        (2, 2, 'Midterm', 62.0, '2024-02-10'),
        (2, 3, 'Essay 1', 81.0, '2024-01-18'),
        (2, 3, 'Quiz 1', 83.0, '2024-01-25'),
        (2, 4, 'Essay 1', 75.0, '2024-01-12'),
    ])

    # Student 3 (Charlie): Declining trend in Math
    grades.extend([
        (3, 1, 'Quiz 1', 80.0, '2024-01-15'),
        (3, 1, 'Quiz 2', 75.0, '2024-01-22'),
        (3, 1, 'Midterm', 68.0, '2024-02-05'),
        (3, 1, 'Quiz 3', 60.0, '2024-02-12'),
        (3, 2, 'Lab 1', 85.0, '2024-01-10'),
        (3, 2, 'Quiz 1', 87.0, '2024-01-20'),
        (3, 3, 'Essay 1', 79.0, '2024-01-18'),
        (3, 4, 'Essay 1', 82.0, '2024-01-12'),
    ])

    # Student 4 (Diana): Consistently good
    grades.extend([
        (4, 1, 'Quiz 1', 91.0, '2024-01-15'),
        (4, 1, 'Quiz 2', 89.0, '2024-01-22'),
        (4, 2, 'Lab 1', 90.0, '2024-01-10'),
        (4, 2, 'Quiz 1', 88.0, '2024-01-20'),
        (4, 3, 'Essay 1', 92.0, '2024-01-18'),
        (4, 3, 'Quiz 1', 90.0, '2024-01-25'),
        (4, 4, 'Essay 1', 87.0, '2024-01-12'),
    ])

    # Student 5 (Eve): Low in Science
    grades.extend([
        (5, 1, 'Quiz 1', 78.0, '2024-01-15'),
        (5, 1, 'Quiz 2', 82.0, '2024-01-22'),
        (5, 2, 'Lab 1', 55.0, '2024-01-10'),
        (5, 2, 'Quiz 1', 58.0, '2024-01-20'),
        (5, 2, 'Midterm', 60.0, '2024-02-10'),
        (5, 3, 'Essay 1', 84.0, '2024-01-18'),
        (5, 4, 'Essay 1', 81.0, '2024-01-12'),
    ])

    # Student 6 (Frank): All low grades
    grades.extend([
        (6, 1, 'Quiz 1', 62.0, '2024-01-15'),
        (6, 1, 'Quiz 2', 58.0, '2024-01-22'),
        (6, 2, 'Lab 1', 64.0, '2024-01-10'),
        (6, 2, 'Quiz 1', 61.0, '2024-01-20'),
        (6, 3, 'Essay 1', 66.0, '2024-01-18'),
        (6, 4, 'Essay 1', 63.0, '2024-01-12'),
    ])

    # Student 7 (Grace): Average across all
    grades.extend([
        (7, 1, 'Quiz 1', 75.0, '2024-01-15'),
        (7, 1, 'Quiz 2', 77.0, '2024-01-22'),
        (7, 2, 'Lab 1', 76.0, '2024-01-10'),
        (7, 2, 'Quiz 1', 78.0, '2024-01-20'),
        (7, 3, 'Essay 1', 74.0, '2024-01-18'),
        (7, 4, 'Essay 1', 79.0, '2024-01-12'),
    ])

    # Student 8 (Henry): Excellent student
    grades.extend([
        (8, 1, 'Quiz 1', 95.0, '2024-01-15'),
        (8, 1, 'Quiz 2', 93.0, '2024-01-22'),
        (8, 2, 'Lab 1', 94.0, '2024-01-10'),
        (8, 2, 'Quiz 1', 92.0, '2024-01-20'),
        (8, 3, 'Essay 1', 96.0, '2024-01-18'),
        (8, 4, 'Essay 1', 91.0, '2024-01-12'),
    ])

    # Student 9 (Iris): Declining across board
    grades.extend([
        (9, 1, 'Quiz 1', 82.0, '2024-01-15'),
        (9, 1, 'Quiz 2', 76.0, '2024-01-22'),
        (9, 1, 'Midterm', 68.0, '2024-02-05'),
        (9, 2, 'Lab 1', 81.0, '2024-01-10'),
        (9, 2, 'Quiz 1', 74.0, '2024-01-20'),
        (9, 3, 'Essay 1', 80.0, '2024-01-18'),
        (9, 3, 'Quiz 1', 72.0, '2024-01-25'),
        (9, 4, 'Essay 1', 79.0, '2024-01-12'),
    ])

    # Student 10 (Jack): Low in multiple courses
    grades.extend([
        (10, 1, 'Quiz 1', 68.0, '2024-01-15'),
        (10, 1, 'Quiz 2', 65.0, '2024-01-22'),
        (10, 2, 'Lab 1', 72.0, '2024-01-10'),
        (10, 2, 'Quiz 1', 69.0, '2024-01-20'),
        (10, 3, 'Essay 1', 70.0, '2024-01-18'),
        (10, 4, 'Essay 1', 67.0, '2024-01-12'),
    ])
